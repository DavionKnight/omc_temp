...
int dru_lmx2531_gsm_slave_dcs_init()//1630.34
{
	...
	emif_epld_spi_write(0x06b1d20,LMX2531_REG_LENGTH );// 1630.34
...
int dru_lmx2531_gsm_main_dcs_init()//1663.9
{
	...
	emif_epld_spi_write(0x0320001,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0362b00,LMX2531_REG_LENGTH );// 1686.4M  联通 dcs
	//emif_epld_spi_write(0x06e05a0,LMX2531_REG_LENGTH );// 1691.4M  联通 dcs
