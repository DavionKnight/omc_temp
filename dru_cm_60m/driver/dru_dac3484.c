...
emif_epld_spi_write(0X172800,DAC3484_REG_LENGTH);         //nco frequence word [15:0]     
...
emif_epld_spi_write(0X165555,DAC3484_REG_LENGTH);         //nco frequence word [15:0]     140.16*2^32/983.04 = 0x24800000
emif_epld_spi_write(0X1730bd,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  AB   76.8M
...
/*if(get_net_group() == 0x331){ // 电信1.8G
	emif_epld_spi_write(0X14aaab,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X150f42,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X16aaab,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X170f42,DAC3484_REG_LENGTH);         
}else{
	...
	emif_epld_spi_write(0X140000,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  AB   76.8M
	emif_epld_spi_write(0X160000,DAC3484_REG_LENGTH);         //nco frequence word [15:0]  // LTE2 通道4   
...
/*if(get_net_group() == 0x331){
	emif_epld_spi_write(0X145555,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X15f685,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X160000,DAC3484_REG_LENGTH);         
	emif_epld_spi_write(0X171c48,DAC3484_REG_LENGTH);         
}else{
	if(get_net_type() == 1){ // 1:gsm 2:dcs
		emif_epld_spi_write(0X160000,DAC3484_REG_LENGTH); //nco 108.6*2^32/983.04 = 0x1c480000  gsm
		emif_epld_spi_write(0X171c48,DAC3484_REG_LENGTH); //nco 
	}else{
		emif_epld_spi_write(0X16aaab,DAC3484_REG_LENGTH); //nco 58.6*2^32/983.04 = 0x0f42aaab dcs 
		emif_epld_spi_write(0X170f42,DAC3484_REG_LENGTH); //nco 
	}
...
emif_epld_spi_write(0X153000,DAC3484_REG_LENGTH);         //nco frequence word [15:0]   58.6*2^32/983.04=0x0f42aaab  92.16*2^32/491.52 =30 000000
emif_epld_spi_write(0X140000,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  AB   76.8M
emif_epld_spi_write(0X160000,DAC3484_REG_LENGTH);         //nco frequence word [15:0]     
emif_epld_spi_write(0X172060,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  CD
...
emif_epld_spi_write(0X1D0000,DAC3484_REG_LENGTH);           //defaut
emif_epld_spi_write(0X1E1111,DAC3484_REG_LENGTH);           //qmc sync source sel 
emif_epld_spi_write(0X1F8880,DAC3484_REG_LENGTH);           // mixer,nco sync source sel ,sif_sync
emif_epld_spi_write(0X202201,DAC3484_REG_LENGTH);           //fifo sync source sel =  sync
emif_epld_spi_write(0X221B1B,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X23FFFF,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X240C00,DAC3484_REG_LENGTH);           // dataclk delay  3bit 011= 3*50 ps=150 ps 000 000 
emif_epld_spi_write(0X257A7A,DAC3484_REG_LENGTH);
...
emif_epld_spi_write(0X2BAAAA,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X2CC6C6,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X2D0004,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X2E0000,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X2F0000,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X300E5C,DAC3484_REG_LENGTH);
emif_epld_spi_write(0X7F0000,DAC3484_REG_LENGTH);      //version read only
emif_epld_spi_write(0X1F8882,DAC3484_REG_LENGTH);      // soft sync
emif_epld_spi_write(0X00f498,DAC3484_REG_LENGTH);      // disable clock_divider_sync
emif_epld_spi_write(0X1F8880,DAC3484_REG_LENGTH);      //clear soft sync
dac2_txen(1);
emif_epld_spi_channel(SELECT_DAC3481_1);
dac1_txen(0);
dac1_reset_n(0);
...
emif_epld_spi_write(0X173000,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  AB   76.8M
emif_epld_spi_write(0X140000,DAC3484_REG_LENGTH);         //nco frequence word [15:0]     wcdma  main 946.64*2^32/983.04 = 0xf6855555
emif_epld_spi_write(0X153000,DAC3484_REG_LENGTH);         //nco frequence word [31:16]  CD
