...
//	spi_delay(10000);
	...
	//emif_epld_spi_write(0x06900b0,LMX2531_REG_LENGTH );// 806.84M
	emif_epld_spi_write(0x0fcc003,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0430042,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0280001,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x06900b0,LMX2531_REG_LENGTH );// 806.84M
...
//	spi_delay(10000);
	...
	emif_epld_spi_write(0x000004,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0xecc003,LMX2531_REG_LENGTH );///=2013.9.13
	emif_epld_spi_write(0x4c0042,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x03e0001,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0662c00,LMX2531_REG_LENGTH );// 790.4M yidong

	return 1;
}
//#endif

int dru_lmx2537_gsm1_init()
{
...
//	emif_epld_spi_write(0x03e2120,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x06ce623,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0568022,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x0281a51,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x03e34c0,LMX2531_REG_LENGTH );
	//emif_epld_spi_write(0x2C0001,LMX2531_REG_LENGTH );//
...
int dru_lmx2531_gsm_init_m_gz(void)
{
	...
	emif_epld_spi_write(0x4c0042,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x3e0001,LMX2531_REG_LENGTH );
	emif_epld_spi_write(0x6d1480,LMX2531_REG_LENGTH );// 840.4M yidong 广州测试
