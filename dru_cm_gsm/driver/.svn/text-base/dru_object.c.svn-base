...
const char * g_type_ver = "MG"; 
const char * g_drv_ver = "04";
const char * g_test_ver = "8"; // 0:正式版 奇数：带测试版 偶数：已测试版本
...
//dru_lmx2531_lte2_init();
	...
	if(get_device_type()==DEVICE_TYPE_MAIN){
		dru_lmx2531_wcdma_config(1925840);// main
	}else{
		dru_lmx2531_wcdma_config(1925840); //RAU
	}
